...
class DataManager:
    ...
    def __init__(self):
        self.endpoint = "https://api.sheety.co/e61a72d0959b83f64a35b5334998a592/flightDeals/prices"
    ...
    def get_subs(self):
        response = requests.get(url="https://api.sheety.co/e61a72d0959b83f64a35b5334998a592/flightDeals/users",
                                headers=self.header)
        response.raise_for_status()
        return response.json()["users"]
   # changes the existing table with the put request
    def put_table(self, iata:str, row:int):
        self.put_request = requests.put(url=f"https://api.sheety.co/e61a72d0959b83f64a35b5334998a592/flightDeals/prices/{str(row)}", json={"price": {"iataCode": iata}}, headers=self.header)
   ...
   # insert the new price
    def put_new_price(self, price:str, row:int):
        self.put_request = requests.put(url=f"https://api.sheety.co/e61a72d0959b83f64a35b5334998a592/flightDeals/prices/{str(row)}", json={"price": {"price": price}}, headers=self.header)
        self.put_request.raise_for_status()
        print(self.put_request)
    ...
    def add_subscriber(self, email, first_name, last_name):
        ...
        response = requests.post(url="https://api.sheety.co/e61a72d0959b83f64a35b5334998a592/flightDeals/users",
